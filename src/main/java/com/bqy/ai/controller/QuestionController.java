...
import com.bqy.ai.model.dto.qusetion.*;
...
public class QuestionController {
    ...
    public BaseResponse<List<QuestionContentDTO>> aiGenerateQuestion(@RequestBody AiGenerateQuestionRequest aiGenerateQuestionRequest) {
        ...
        //封装prompt
        String userManager = getGenerateQuestionUserMessage(app, questionNumber, optionNumber);
        //AI生成
        String result = aiManager.doSyncRequest(GENERATE_QUESTION_SYSTEM_MESSAGE, userManager, null);
    ...
    public SseEmitter aiGenerateQuestionSse(AiGenerateQuestionRequest aiGenerateQuestionRequest) {
        ...
        //AI生成，SSE流式返回
        Flowable<ModelData> modelDataFlowable = aiManager.doStreamRequest(GENERATE_QUESTION_SYSTEM_MESSAGE, userManager, null);
        //左括号计数器除了默认值外，当回归为0时表示左括号等于右括号
